...
async function main(){
    ...
    const myKeypair = loadWalletKey("/Users/nikostsolakos/TIMECAPSULE/timecapsuletokensol/id.json");
    const mint = new web3.PublicKey("3oXgCCvv91bAoQeP5TjPCKCUwuj1GVUxixdMgx818vtW");
    ...
    const ourMetadata = { // TODO change those values!
        name: "TimeCapsule", 
        symbol: "TCA",
        uri: "https://raw.githubusercontent.com/timecapsuletoken/solana/main/metadata.json",
    }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
